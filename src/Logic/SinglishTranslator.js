...
let consonantsUni= new Array()
let vowels= new Array()
let vowelsUni= new Array()
let vowelModifiersUni= new Array()
let specialConsonants= new Array()
let specialConsonantsUni= new Array()
let specialCharUni= new Array()
let specialChar= new Array()
